...
database.ref().on("child_added", function(childSnapshot) {
  ...
  addRow(sv.dbTrain, sv.dbDestination, sv.dbFrequency, sv.dbNextArrival, sv.dbMinutesAway);
...
var addRow = function(train, destination, frequency, arrivalNext, minutesAway) {
    var row = $('<tr>');
